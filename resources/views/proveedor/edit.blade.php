            ...
            <form action="{{route('proveedores.update',['proveedore'=>$proveedore])}}" method='post' >
                ...
                <div class="row g-3">
                    <div class="col-md-4 mb-2">
                        <label for='tipo_persona' class="form-label">Tipo proveedor: <span class="fw-bold">{{strtoupper($proveedore->persona->tipo_persona)}}</span></label>                        
                    </div>
                    ...
                    <div class="col-md-12 mb-2" >
                        ...
                        <input type="text" id="razon_social" name="razon_social" class="form-control" value="{{old('razon_social',$proveedore->persona->razon_social)}}">
                        @error('razon_social')
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <input type="text"  name="direccion"  id="direccion" rows="3" class="form-control" value="{{old('direccion',$proveedore->persona->direccion)}}">
                        @error('direccion')
                        <small class="text-danger">{{'* '.$message}}</small>
                        @enderror
                    </div> 
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" id="numero_documento" name="numero_documento" class="form-control" value="{{old('numero_documento',$proveedore->persona->numero_documento)}}">
