                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="text-muted mb-0">{{$proveedore->persona->numero_documento}}</p>
                                            </td>
                                            <td>{{strtoupper($proveedore->persona->tipo_persona)}}</td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                    ...
                                                    @else
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$proveedore->id}}">Restaurar</button>
                                                    @endif
                                                    @endcan
                                              </div>
                                            </td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                      ...
                                                      {{$proveedore->persona->estado == 1 ? '¿Seguro que quieres eliminar este proveedor? ':'¿Seguro que quieres restaurar este proveedor? ' }}
                                                    </div>
