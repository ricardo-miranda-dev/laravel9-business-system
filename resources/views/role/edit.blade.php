    ...
    <form action="{{route('roles.update',['role'=>$role])}}" method='post'>
        ...
        <div class="row g-3">
            ...
            <div class="row mb-4 mt-4">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="name" id="name" placeholder="" value="{{old('name',$role->name)}}">
                        </div>
                        <div class="col-sm-6">
                            @error('name')
                    ...
                    <div class="col-12 mb-4">
                        ...
                        @if(in_array($item->id,$role->permissions->pluck('id')->toArray()))
                            ...
                            <input checked type="checkbox" class="form-check-input" name="permission[]" id="{{$item->id}}" value='{{$item->name}}' >
