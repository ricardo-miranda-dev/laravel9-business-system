...
<div class="container-fluid px-4">
        ...
        <div class="container w-100 border border-3 border-primary rounded p-4 mt-3">
            <div class="row mb-2">
                ...
                <div class="col-sm-8">                    
                    <input disabled type="text" class="form-control" name="" id="" placeholder="" value='{{$compra->comprobante->tipo_comprobante}} '>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-sm-4">
                ...
                <div class="col-sm-8">                    
                    <input disabled type="text" class="form-control" name="" id="" placeholder="" value='{{$compra->numero_comprobante}} '>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-sm-4">
                    ...
                    <input disabled type="text" class="form-control" name="" id="" placeholder="" value='Proveedor: '>
                    </div>
                </div>
                <div class="col-sm-8">                    
                    <input disabled type="text" class="form-control" name="" id="" placeholder="" value='{{$compra->proveedore->persona->razon_social}} '>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-sm-4">
                ...
                <div class="col-sm-8">                    
                    <input disabled type="text" class="form-control" name="" id="" placeholder="" value='{{ \Carbon\Carbon::parse($compra->fecha_hora)->format('d-m-Y')}} '>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-sm-4">
                ...
                <div class="col-sm-8">                    
                    <input disabled type="text" class="form-control" name="" id="" placeholder="" value='{{ \Carbon\Carbon::parse($compra->fecha_hora)->format('H:i')}} '>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-sm-4">
                ...
                <div class="col-sm-8">                    
                    <input disabled type="text" class="form-control" name="input_impuesto" id="input_impuesto" placeholder="" value='{{ $compra->impuesto}}'>
                </div>
            </div>
